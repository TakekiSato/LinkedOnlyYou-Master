...
namespace Pencil_4
{
    ...
    public class PencilLineEffect : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                if (this.LineListObject == null)
                {
                    this.LineListObject = Instantiate(Prefabs.LineList);
                    this.LineListObject.name = Prefabs.LineList.name;
                }
            }
#endif
        }
        ...
        public bool isRendering {
            ...
            set
            {
                if (value != _isRendering)
                {
                    ...
                    if (_isRendering)
                    {
                        pencilRenderer.BeginRenderProcess();
                    }
                    else
                    {
        ...
        private void Preprepare()
        {
            if (LineListObject != null)
            {
                ...
                if (lineListNode != null)
                {
                    ...
                    //
                    pencilRenderer.RenderPreprocessAsync(lineListNode, timeout, !isPostProsessingEnabled);
                }
            }
